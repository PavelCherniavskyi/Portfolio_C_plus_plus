...
int queen(int x1, int y1 )
{
	...
	else if (flag_local == 3){
		steps[0] = { -1, 0 }; steps[1] = { -2, 0 }; steps[2] = { -3, 0 }; steps[3] = { -4, 0 }; steps[4] = { -5, 0 }; steps[5] = { -6, 0 }; steps[6] = { -7, 0 };
		flag_local = 0;
	}
	else if (flag_local == 4){
		steps[0] = { 1, 1 }; steps[1] = { 2, 2 }; steps[2] = { 3, 3 }; steps[3] = { 4, 4 }; steps[4] = { 5, 5 }; steps[5] = { 6, 6 }; steps[6] = { 7, 7 };
		flag_local++;
	}
	else if (flag_local == 5){
		steps[0] = { -1, 1 }; steps[1] = { -2, 2 }; steps[2] = { -3, 3 }; steps[3] = { -4, 4 }; steps[4] = { -5, 5 }; steps[5] = { -6, 6 }; steps[6] = { -7, 7 };
		flag_local++;
	}
	else if (flag_local == 6){
		steps[0] = { 1, -1 }; steps[1] = { 2, -2 }; steps[2] = { 3, -3 }; steps[3] = { 4, -4 }; steps[4] = { 5, -5 }; steps[5] = { 6, -6 }; steps[6] = { 7, -7 };
		flag_local++;
	}
	else{
